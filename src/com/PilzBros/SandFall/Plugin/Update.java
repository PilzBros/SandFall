...
public class Update {
     ...
     */
    public Update(int projectID, SandFall sf) 
    {
        this(projectID, null, sf);
    }
     ...
     */
    public Update(int projectID, String apiKey, SandFall sf) {
    ...
    public void query() {
        ...
        try {
            ...
            if (array.size() > 0) 
            {
                ...
                if (Double.parseDouble(versionName) > Double.parseDouble(SandFall.pluginVersion))
                {
